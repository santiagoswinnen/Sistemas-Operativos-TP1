...
void write_to_md5 (char **md5, char *pipe_content, int md5_index,
    size_t message_length);
void send_data_to_view (char *shm_address, sem_t *sem, char **md5,
    int md5_index, int file_amount, int folder_count);
